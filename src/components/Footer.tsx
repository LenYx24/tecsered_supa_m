...
const Footer = () => {
  return (
    <footer
      className="footer bg-slate-800  p-10 text-main"
      data-theme="cupcake"
    >
      <div>
      ...
      <div>
        ...
        <a className="link-hover link">Felhasználási feltételek</a>
        <a href="https://storyset.com/work">Work illustrations by Storyset</a>
      </div>
      <div>
        <span className="footer-title">Média</span>
        <div className="grid grid-flow-col gap-4">
          <a>
            <svg
              ...
              height="24"
              viewBox="0 0 24 24"
              className="cursor-pointer fill-current hover:scale-110 hover:text-unique"
            >
